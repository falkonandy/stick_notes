"""
Django settings for stick_notes project.
...
SECRET_KEY = (
    'django-insecure-!u@om1(bhnn43ep9x@7^#p%3)7e_)j5!6=5#vu03id!eu*z0wx'
)
...
WSGI_APPLICATION = 'stick_notes.wsgi.application'
